...
public class FilterByCategoryAdapter extends RecyclerView.Adapter<FilterByCategoryAdapter.ViewHolder>{
    public static final String TAG = "CategoryAdapter";
    private Context context;
    private ArrayList<MealDTO> meals;

    public FilterByCategoryAdapter(Context context, ArrayList<MealDTO> meals) {
    ...
    @NonNull
    @Override
    public FilterByCategoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.category_row, parent, false);
        return new FilterByCategoryAdapter.ViewHolder(view);
    }
