...
public class FilterCountryDetailsActivity extends AppCompatActivity implements OnMealClickListener, IFilterByCountryView {
    private RecyclerView mealsRecyclerView;
    private MealsAdapter mealsAdapter;
    private FilterByCountryPresenter mealByCountryPresenter;
